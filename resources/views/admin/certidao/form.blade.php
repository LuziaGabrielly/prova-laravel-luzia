<div class="form-group">
    ...
    <input type="text" class="form-control" id="tipo" name="tipo_certidao" value="{{$item->tipo_certidao ?? ''}}">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="tabeliao" name="envolvido2" value="{{$item->tabeliao ?? ''}}">
</div>